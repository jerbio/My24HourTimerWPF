...
namespace My24HourTimerWPF
{
    public class CalendarEvent
    {
        ...
        public TimeLine PinSubEventsToEnd(TimeLine MyTimeLine, List<SubCalendarEvent> MySubCalendarEventList)
        {
            /*
            ...
            foreach (SubCalendarEvent MySubCalendarEvent in MySubCalendarEventList)
            {
                DateTime MyStartTime = ReferenceTime - MySubCalendarEvent.ActiveDuration;
                MySubCalendarEvent.ActiveSlot = new BusyTimeLine(MySubCalendarEvent.ID, (MyStartTime), ReferenceTime);
                ReferenceTime = MyStartTime;
        ...
        public bool updateSubEvent(EventID SubEventID,SubCalendarEvent UpdatedSubEvent)
        {
            ...
            else 
            {
                ...
                for (i = 0; i < ArrayOfSubEvents.Length;i++)
                {
                    ...
                    {
                        ArrayOfSubEvents[i] = UpdatedSubEvent;
                        return true;
                    }
                }
            }
