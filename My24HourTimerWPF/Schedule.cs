...
namespace My24HourTimerWPF
{
    public class Schedule
    {
        ...
        public void EmptyAllCalendarEvent()//MyTemp Function for deleting all calendar events
        {
            ...
            {
                myCalendar[0].RemoveFromOutlook(ArrayOfValues[i]); //this removes the value from outlook
        ...
        List<SubCalendarEvent> SpreadOutEvents(List<SubCalendarEvent> AlreadyAlignedEvents)
        {
            return AlreadyAlignedEvents.ToList();
        }
