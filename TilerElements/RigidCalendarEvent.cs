...
namespace TilerElements
{
    public class RigidCalendarEvent: CalendarEvent
    {
        public RigidCalendarEvent(
            ...
            EventDisplay UiData, MiscData NoteData, bool EnabledEventFlag, bool CompletionFlag, TilerUser creator, TilerUserGroup users, string timeZone, EventID eventId, NowProfile nowProfile, UpdateHistory updateHistory, bool initializeSubCalendarEvents = true, Classification semantics = null, int split = 1)
            : base(
                 NameEntry, StartData, EndData, EventDuration, eventPrepTime, PreDeadlineTimeSpan, split, EventRepetitionEntry, UiData, NoteData, EnabledEventFlag, CompletionFlag, nowProfile, null, EventLocation, creator, users, false, DateTimeOffset.UtcNow, timeZone, semantics, updateHistory)
        {
