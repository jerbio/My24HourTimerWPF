...
namespace TilerElements.Wpf
{
    public static class Utility
    {
        ...
        public static string CalculateMD5Hash(string input)///gotten from https://blogs.msdn.microsoft.com/csharpfaq/2006/10/09/how-do-i-calculate-a-md5-hash-from-a-string/
        {
            // step 1, calculate MD5 hash from input

            MD5 md5 = System.Security.Cryptography.MD5.Create();
            input += "It'sAllHashedBecauseItIsFreakingAwesomeWithSomeSaltyIsh:)";
