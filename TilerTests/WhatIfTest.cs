...
namespace TilerTests
{
    ...
    public class WhatIfTest
    {
        ...
        public async Task WhatIfIPushedAllFromDumpEvents()
        {
            ...
            //var findMeSomethingToDoDump = TestUtility.getSchedule(scheduleId, currentTime);
            //TestUtility.getSchedule(scheduleId, currentTime);
            //TestSchedule findSomethingTodSchedule = (TestSchedule)findMeSomethingToDoDump.Item1;
            //findSomethingTodSchedule.FindMeSomethingToDo(currentLocation).Wait();
